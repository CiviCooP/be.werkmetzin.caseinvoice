 ...
 *
 */
class CRM_Caseinvoice_Controller_CompleteInvoices extends CRM_Core_Controller {
  ...
  public function __construct($title = NULL, $modal = TRUE, $action = CRM_Core_Action::NONE) {
    ...
    $this->_stateMachine = new CRM_Caseinvoice_StateMachine_CompleteInvoices($this, $action);
